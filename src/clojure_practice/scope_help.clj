...
(defn f3 []
	...
	; sameglobal binding with new, temporary value
	(binding [v 3]
		; global binding, new value.
		(println "f3: within binding function v:" v)
		(f1)) ; calling f1 with new value in v
	; outside of binding v refers to first global variable.
	(println "f3: after binding v:" v))

(defn f4 []
 (def v 4)) ; changes value of v in global scope
